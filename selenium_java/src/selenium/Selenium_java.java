...
public class Selenium_java implements Job {
	...
	public void selenium() {
		...
		try {
			...
			//출발시간 고르기
			js("document.querySelector(\"#s_hour > option:nth-child(14)\")","document.querySelector(\"#s_hour > option:nth-child(14)\").selected=true");			
			//전송
			js("document.querySelector(\"#center > form > div > p > a\")","document.querySelector(\"#center > form > div > p > a\").click()");
			//좌석선택하기
			...
			//선택좌석예약하기
			js("document.querySelector(\"#Confirm > a\")"
			,"document.querySelector(\"#Confirm > a\").click()");
			...
			js("document.querySelector(\"#name\")"
			,"document.querySelector(\"#name\").value='서호영'");
			...
			js("document.querySelector(\"#pw\")"
			,"document.querySelector(\"#pw\").value='86245'");
			js("document.querySelector(\"#pw_s\")"
			,"document.querySelector(\"#pw_s\").value='86245'");
			...
			Thread.sleep(500);
			js("document.querySelector(\"#contents > div.content > form > div > p:nth-child(7) > a\")","document.querySelector(\"#contents > div.content > form > div > p:nth-child(7) > a\").click()");
	...
	public void js(String obj, String code) {
		...
		String temp = "console.dir(" + obj + ");"
		+ " while(true){if(" + obj + "){" + code + "; break;}}";
