...
<body>
	...
	<div class="search-box">
			...
			<tbody>
				<c:forEach items="${data.ndata }" var="notice">
					<tr>
						...
						<td class="subject"><a
							href="/servletBM/notice/noticedetail.do?noticeNo=${notice.noticeNo }">${notice.noticeTitle }</a></td>
		...
		<div class="paging">
			<!-- section pagination -->
			<a href="/servletBM/notice/noticelist.do" class="nav first"> 
			<i class="fas fa-angle-double-left"></i></a> 
			<a href="/servletBM/notice/noticelist.do?cPage=${data.paging.blockStart - 1}"
			...
			<a href="/servletBM/notice/noticelist.do?cPage=${data.paging.blockEnd + 1}"
				class="nav next"><i class="fas fa-angle-right"></i></a> 
			<a href="/servletBM/notice/noticelist.do?cPage=${data.paging.lastPage}"
