...
<body>
	...
	<form action="/servletBM/book/innersearch.do" method="post">
		<div class="Menu">
			<div class="MenuBox">
				<span>검색 결과 내 검색 : </span><input type="text" name="title" /><br>
				<span>인기순 정렬 : </span><input type="radio" name="orderBy"
					value="B_RENT_CNT" /> <span>ISBN : </span><input type="radio"
					name="orderBy" value="B_ISBN" /><br>
				<button>검색</button>
			</div>
		</div>
		<br> <br>
